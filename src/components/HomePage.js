...
const HomePage = () => {
  return (
    <>
      ...
      <div className="h-40 w-full bg-gradient-to-l from-cyan-200 to-green-500 shadow-lg rounded-b-lg my-6 sm:my-10"></div>
      ...
      <div className="h-40 w-full bg-gradient-to-r from-cyan-200 to-lightblue-800 shadow-lg rounded-b-lg my-6 sm:my-10"></div>
      <div className="max-w-screen-sm mx-auto text-gray-800">
        <p className="text-4xl text-center tracking-tight font-extrabold py-10 sm:py-20">
          About Me
        </p>
      ...
      <div className="h-40 w-full bg-gradient-to-l from-green-500 to-lightblue-800 shadow-lg rounded-b-lg my-6 sm:my-10"></div>
      <div className="max-w-screen-sm mx-auto text-gray-800">
        <p className="text-4xl text-center tracking-tight font-extrabold py-10 sm:py-20">
          Contact Me
        </p>
